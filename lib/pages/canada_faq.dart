...
final List<Entry> data = <Entry>[
  Entry(
    ...
    <Entry>[
      Entry('It is recommended that travel plans be cancelled. Your decision should be made based off of the country that you live in and the place you are travelling to. The Coronavirus has spread greatly, and many countries are in lockdowns and don\'t allow international travel. If you have a travel insurance, the best choice is to cancel the plans. '),
    ],
  ),
  Entry(
    'What should I do if I have recently returned from travelling outside of Canada?',
    <Entry>[
      Entry('The government of Canada has an emergency order in place under the Quarantine act where all incoming travellers would have to: provide basic info. that is being asked, and undergo a screening by a service/quarantine officer. Travellers with symptoms are to isolate immediately. '),
    ],
  ),
  Entry(
